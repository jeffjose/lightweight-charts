...
export function drawSquare(
	...
	const radius = 3;
	const roundedRectParams: RoundedRectData = { topLeftRadius: radius, topRightRadius: radius, lowerLeftRadius: radius, lowerRightRadius: radius, stroke: true, fill: true, lineWidth: 2, lineStyle: LineStyle.Solid, strokeColor: item.color, fillColor: 'rgba(0, 0, 0, 0)' };
